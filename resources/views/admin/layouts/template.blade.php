        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Ecommerce-app</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href={{route('allcategory')}} class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics">ALL Categort</div>
                </a>
              </li>
              <li class="menu-item">
              ...
              <li class="menu-item">
                  <a href={{route('allsubcategory')}} class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
                    <div data-i18n="Analytics">ALL Sub-Categort</div>
                  </a>
                </li>
                <li class="menu-item">
                    ...
                    <li class="menu-header small text-uppercase">
                      ...
                      <li class="menu-item">
                          <a href={{route('pendingorder')}} class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Panding Orders</div>
                          </a>
                        </li>
                        <li class="menu-item">
                          <a href={{route('admindashboard')}} class="menu-link">
